        ...
        <div class="col-md-8 m-auto">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <!-- form start -->
                    <form role="form" action="{{url('/Submit-User')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group">                                  
                                ...
                                <input type="text" name="user_name" placeholder="User Name" class="form-control" value="{{old('user_name')}}" required=""> 
                            ...
                            <div class="form-group">                                  
                                ...
                                <input type="email" name="login_email" placeholder="Login Email ID" class="form-control" value="{{old('login_email')}}" required=""> 
