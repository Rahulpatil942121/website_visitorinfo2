    ...
    <div class="box">
        <div class="box-header">
           <!--  <h3 class="box-title">Data Table With Full Features</h3> -->
            ...
            <div class="" style="">
                <a href="{{url('/Add-User')}}" class="btn btn-primary btn-flat btn-sm" style="float: right;margin-right: 40px;margin-bottom: 2px;">Add Client</a>
            </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        @endphp
                            <td>{{$user_type}}</td>
                            @php 
                            $company = DB::table('companynames')->where('id',$list->comp_name)->value('company_name');
                        @endphp
                            <td>{{$company}}</td>
