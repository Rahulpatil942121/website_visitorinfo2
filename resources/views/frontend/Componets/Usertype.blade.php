                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>                                
                                <a href="{{url('/Edit-Type')}}/{{$list->id}}" class="btn btn-info btn-sm" style="margin-right: 5px;"><i class="fa fa-fw fa-edit"></i></a>
                                <a href="{{url('/Delete-Type')}}/{{$list->id}}" class="btn @if($list->status == 1) btn-danger @else btn-success @endif btn-sm btn_delete" title="Change Status">@if($list->status == 1) D-Active @else Active @endif</a>
                            </td>                             
                        </tr>
                        @endforeach                       
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
               <form action="{{url('/Add-User-Type')}}" method="post">
                @csrf
